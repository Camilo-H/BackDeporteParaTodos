...
public class ImagenGateway implements IImagenGateway {
    ...
    public Imagen insertarImagen(Imagen imagen) {
        ...
        // el retorno de la insercion es una imagen entidad, por tanto se mapea a imagen
    ...
    public Imagen obtenerImagen(Integer id) {
        ...
        // se hace un mapeo mediante ModelMapper, recordando que se obtiene en la
        // consulta un optional<ImagenEntidad>
